...
export default function SettingsPage() {
  ...
  const [form, setForm] = useState({
    initialCapital: '', riskPercent: '', broker: '', tradingStyle: 'Intraday',
    ...
    <div className="space-y-5 animate-fade-in max-w-xl">
      ...
      <form onSubmit={handleSave} className="space-y-5">
        <Card accent="#a78bfa">
          ...
          <div className="space-y-4">
            ...
            <Input label="BROKER / PLATFORM" placeholder="MetaTrader 5, NinjaTrader..." value={form.broker}
          ...
          <Btn type="submit" disabled={updateSettings.isPending} className="mt-5 w-full py-3" variant="outline">
            {updateSettings.isPending ? 'SAVING...' : 'SAVE TRADING SETTINGS →'}
          </Btn>
        </Card>
      </form>
      ...
      <form onSubmit={handleProfile}>
        <Card>
          ...
          <Btn type="submit" className="mt-4 w-full py-2.5" variant="ghost">UPDATE PROFILE</Btn>
        </Card>
      </form>
      ...
      <form onSubmit={handlePassword}>
        <Card>
          ...
          <Btn type="submit" className="mt-4 w-full py-2.5" variant="ghost">CHANGE PASSWORD</Btn>
        </Card>
      </form>
    </div>
  );
